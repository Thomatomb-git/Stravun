...
class HomeProvider extends ChangeNotifier {
  ...
  Future<void> _handleMissions(String uid) async {
    ...
    UserMissionProgress? progress = await _firestoreService
        .getUserMissionProgress(uid, cycle.id);

    // Create new progress if it doesn't exist
    if (progress == null) {
      progress = UserMissionProgress(userId: uid, missionCycleId: cycle.id);
